...
export const resources: Resource[] = [
  ...
  {
    id: 26,
    title: "Instituto Brasileiro de Direito de Familia",
    description:
      "Informacoes sobre direitos de familia, guarda de filhos, pensao alimentar e outros aspectos legais que afetam mulheres.",
    url: "https://www.ibdfamilia.org.br/",
    category: "direitos",
    tags: ["familia", "guarda", "pensao", "direitos", "filhos"],
  },
  {
    id: 27,
    title: "SEBRAE - Mulher Empreendedora",
    description:
      "Programa de capacitacao em empreendedorismo e gestao de negocios para mulheres que desejam iniciar seu proprio empreendimento.",
    url: "https://www.sebrae.com.br/sites/PortalSebrae/mulher",
    category: "capacitacao",
    tags: ["empreendedorismo", "negocio", "SEBRAE", "mulher"],
  },
  {
    id: 28,
    title: "UNFPA Brasil - Saude Reprodutiva",
    description:
      "Informacoes sobre saude reprodutiva, direitos sexuais e reprodutivos, e programas de bem-estar feminino.",
    url: "https://brazil.unfpa.org/pt-br",
    category: "saude",
    tags: ["saude reprodutiva", "direitos", "UNFPA", "bem-estar"],
  },
  {
    id: 29,
    title: "Conselho Nacional de Direitos da Mulher",
    description:
      "Entidade que promove e defende os direitos das mulheres, com informacoes sobre politicas publicas e legislacao.",
    url: "https://www.gov.br/mdh/pt-br/assuntos/mulheres",
    category: "direitos",
    tags: ["CNDM", "direitos", "politicas", "governo"],
  },
  {
    id: 30,
    title: "Rede Feminista de Saude",
    description:
      "Rede de organizacoes que promove saude integral da mulher, com foco em educacao, prevencao e atendimento humanizado.",
    url: "https://www.redesaude.org.br/",
    category: "saude",
    tags: ["saude", "feminista", "prevencao", "educacao"],
  },
];
