      ...
      <section className="bg-terracotta/5 py-10">
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 max-w-4xl mx-auto">
            {[
              { number: "30", label: "Recursos Disponíveis", icon: Sparkles },
      ...
      <footer className="bg-terracotta-dark text-cream/80 py-10">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xs text-cream/50 mt-6 border-t border-cream/20 pt-4">
              Desenvolvido por Matheus Ferreira<br />
              Aluno de Ciências da Computação - UFBRA
            </p>
          </div>
        </div>
      </footer>
